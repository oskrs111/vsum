...
<!DOCTYPE html>
<head>
<title>VSUM - Demo - Register</title>
...
<div id="wrapper">
  ...
  <div id="main">    
    <div class="left">
      <h3>Registration form demo</h3>
      <p>Here you can register to this demo page.<br/>
	  Note that you user will be deleted while database maintenance...
	  </p>
	  <!-- VSUM CODE BLOCK -->
      ...
      <input name="submit" type="submit" value="Registrar" class="button"/>                                    
	  </fieldset>
